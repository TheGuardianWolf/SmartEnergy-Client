...
dashboard.partial += "            <li class=\"overview\" data-view=\"overview\">";
dashboard.partial += "                <a href=\"#\">";
dashboard.partial += "                    <span class=\"mif-apps icon\"><\/span>";
dashboard.partial += "                    <span class=\"title\">Overview<\/span>";
dashboard.partial += "                <\/a>";
dashboard.partial += "            <\/li>";
dashboard.partial += "            <li class=\"recent\" data-view=\"recent\">";
dashboard.partial += "                <a href=\"#\">";
dashboard.partial += "                    <span class=\"mif-heartbeat icon\"><\/span>";
dashboard.partial += "                    <span class=\"title\">Recent Usage<\/span>";
dashboard.partial += "                    <span class=\"counter\">0<\/span>";
dashboard.partial += "                <\/a>";
dashboard.partial += "            <\/li>";
dashboard.partial += "            <li class=\"history\" data-view=\"history\">";
dashboard.partial += "                <a href=\"#\">";
dashboard.partial += "                    <span class=\"mif-history icon\"><\/span>";
...
<div id="dashboard" class="dashboard page-content">
    ...
    <div class="page-content">
        <ul class="sidebar">
            <li class="overview" data-view="overview">
                <a href="#">
                    <span class="mif-apps icon"></span>
                    <span class="title">Overview</span>
                </a>
            </li>
            <li class="recent" data-view="recent">
                <a href="#">
            ...
            <li class="history" data-view="history">
                <a href="#">
